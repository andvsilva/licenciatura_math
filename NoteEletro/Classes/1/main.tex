...
Expresse os vetores unitários \( \hat{\mathbf{r}}, \hat{\mathbf{\theta}}, \hat{\mathbf{\phi}} \) em termos de \( \hat{\mathbf{x}}, \hat{\mathbf{y}}, \hat{\mathbf{z}} \) 
(ou seja, derive a Eq. 64). Verifique suas respostas de várias formas 
\(\left( \hat{\mathbf{r}} \cdot \hat{\mathbf{r}} \stackrel{?}{=} 1, \hat{\mathbf{\theta}} \cdot \hat{\mathbf{\phi}} \stackrel{?}{=} 0, \hat{\mathbf{r}} \times \hat{\mathbf{\theta}} \stackrel{?}{=} \hat{\mathbf{\phi}}, \dots \right)\).  

Também determine as fórmulas inversas, expressando \( \hat{x}, \hat{y}, \hat{z} \) em termos de \( \hat{\mathbf{r}}, \hat{\mathbf{\theta}}, \hat{\mathbf{\phi}} \) (e \( \theta, \phi \)).
...
Para determinar \( \hat{\mathbf{r}}, \hat{\mathbf{\theta}}, \hat{\mathbf{\phi}} \), vamos pensar no seguinte conceito, a varia\c{c}\~ao
