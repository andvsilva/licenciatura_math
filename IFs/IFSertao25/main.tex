...
\author{Andr\'e V. Silva \\ \texttt{\url{www.andrevsilva.com}} \\ Caderno de Quest\~oes \\ 
\texttt{\href{https://andrevsilva.com/provas_if/caderno_questoes_ifsertao.pdf}{Caderno de Quest\~oes IF Sert\~ao 2025}}}
...
\boxed{
\begin{aligned}
W_r &=  \frac{m g v_0 }{\beta} \Bigg[1 - \left(\frac{g}{\beta v_0}\right)\ln \left( 1 + \frac{\beta v_0}{g} \right) \Bigg] - \frac{m v_0^2}{2}
\end{aligned}
}
\quad \blacksquare
\]
